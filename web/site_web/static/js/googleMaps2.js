$(function () {
    ...
    for(i =1; i<= list_size; i++)
    {
        ...
        issueid = Number(document.getElementById(issueid).innerHTML);
        ...
        infoMessage[i] = '<b>Make :</b> '+ manufacturer + '<br> <b>Type :</b> '+ vehicle_type +'<br> <b>Colour :</b>'+ vehicle_colour + '<br> <b>Registration :</b> '+registration + ' <br><b>Issue :</b> '+ issue + '';
    }
